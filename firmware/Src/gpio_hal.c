...
void initialize_gpio_hal()
{
	...
	configure_gpio_pin(GPIOA, GPIO_PIN_12, GENERAL_PURPOSE, PUSH_PULL, LOW, NO_PUPD); // Configure PA12 (Y_MOT_M0)
	configure_gpio_pin(GPIOA, GPIO_PIN_11, GENERAL_PURPOSE, PUSH_PULL, LOW, NO_PUPD); // Configure PA11 (Y_MOT_M1)
