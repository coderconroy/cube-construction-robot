...
\begin{acronym}[CSMACD]
  ...
  \acro{BOR}{brown out reset}
  \acro{BRIEF}{binary robust independent elementary features}
  \acro{CAD}{Computer-Aided Design}
  \acro{CMSIS}{Common Microcontroller Software Interface Standard}
  ...
  \acro{GLAD}{Multi-Language GL/GLES/EGL/GLX/WGL Loader-Generator}
  ...
  \acro{RCC}{Reset and clock control}
